...
let livingPlace = prompt(
	"Enter place of living: 'Kyiv', 'Washington' or 'London'"
);

if (
	livingPlace === null ||
	livingPlace.trim() === "" ||
	isNaN(livingPlace) !== true
) {
...
let kindOfSport = prompt(
	"Enter your favourite kind of sport: 'Basketball', 'Football' or 'Tenis'"
);

if (
	kindOfSport === null ||
	kindOfSport.trim() === "" ||
	isNaN(kindOfSport) !== true
) {
