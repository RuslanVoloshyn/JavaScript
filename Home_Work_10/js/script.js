...
alert(
	`1) Сума додатніх значень масиву: ${value}\nКількість додатніх чисел: ${counter}`
);
...
alert(
	`2) Значення мінімального елементу масиву = ${minimum}\nЙого порядковий номер ${
		counter + 1
	}`
);
...
alert(
	`3) Значення максимального елементу масиву = ${maximum}\nЙого порядковий номер ${
		counter + 1
	}`
);
